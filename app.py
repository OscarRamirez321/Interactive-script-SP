...
# --- VISUAL STYLES (CORREGIDO - SIN BORDES BLANCOS) ---
st.markdown("""
    <style>
    /* 1. FONDO GENERAL (NEGRO AZULADO) */
    .stApp {
    ...
    /* 3. ARREGLO DE LOS DROPDOWNS (SELECT BOXES) - CAJA OSCURA */
    div[data-baseweb="select"] > div {
        background-color: #1c2333 !important; /* Fondo Oscuro Sólido */
        border: 1px solid rgba(255, 255, 255, 0.2) !important;
        color: white !important;
    }
    /* El texto dentro del dropdown */
    div[data-baseweb="select"] span {
        color: white !important;
    }
    /* El menú que se despliega (las opciones) */
    ...
    /* 4. ARREGLO DE INPUTS (TEXTO DE UNA LÍNEA) - CAJA OSCURA */
    .stTextInput input {
        background-color: #1c2333 !important; /* Fondo Oscuro Sólido */
        color: white !important;
        border: 1px solid rgba(255, 255, 255, 0.2) !important;
    ...
    /* 5. ARREGLO DEL SCRATCHPAD (ESTILO PAPEL BLANCO) */
    /* Este es el único que dejamos blanco porque es el bloc de notas */
    .stTextArea textarea {
    ...
    /* 6. CAJAS DE SERVICETITAN (CODE BLOCKS) - NEGRO MATRIX */
    .stCodeBlock {
        background-color: #000000 !important;
        border: 1px solid #333 !important;
    }
    .stCodeBlock code {
        color: #00ff00 !important; /* Texto Verde Matrix */
        font-family: 'Courier New', monospace !important;
    }

    /* 7. BOTONES (ESTILO GLASS) */
    .stButton button {
    ...
    /* 8. CAJAS DE DIÁLOGO Y CONTACTOS */
